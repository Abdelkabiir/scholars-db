export const CenturiesData = {
  centuries: [
    {
      id: 1,
      pages: ["فقهاء الصحابة", "فقهاء المدينة", "مفسرون في القرن 1 هـ"],
      subCategories: [
        "أبو حنيفة النعمان",
    ...
    {
      id: 2,
      pages: ["فقهاء المدينة", "مفسرون في القرن 2 هـ"],
      subCategories: [
        "أبو جعفر الفارسي",
        "أبو زكريا الفراء",
        "أبو عبد الله القرشي",
        ...
        "علماء الصحابة",
        "علماء مسلمون في القرن الثاني الهجري",
    ...
    {
      id: 4,
      pages: ["ابن عبد البر", "مفسرون في القرن 4 هـ"],
      subCategories: [
        "أبو الحسن الحوفي",
        "أبو الحسن القابسي",
    ...
    {
      id: 5,
      pages: ["ابن عبد البر", "مفسرون في القرن 5 هـ"],
      subCategories: [
    ...
    {
      id: 6,
      pages: ["ابن رشد", "مفسرون في القرن 6 هـ"],
      subCategories: [
        "أبو القاسم السهيلي",
        "أبو حامد الغزالي",
    ...
    {
      id: 7,
      pages: ["ابن سيد الناس", "فقهاء في القرن 7 هـ", "مفسرون في القرن 7 هـ"],
      subCategories: [
    ...
    {
      id: 9,
      pages: ["فقهاء في القرن 9 هـ", "مفسرون في القرن 9 هـ"],
      subCategories: [
        "أبو العباس القلقشندي",
